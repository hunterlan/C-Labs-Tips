...
int main()
{
	...
	ListOfStudents * list;
	Student student;
	strcpy(student.firstName, "Konstantin");
	strcpy(student.lastName, "Konstantinov");
	strcpy(student.middleName, "Konstantinovich");
	strcpy(student.group, "1.KIT102.8b");
	list = Init(student);
	strcpy(student.firstName, "Ivan");
	strcpy(student.lastName, "Ivanov");
	strcpy(student.middleName, "Ivanovich");
	strcpy(student.group, "1.KIT102.8b");
	list = Add(list, student);
	strcpy(student.firstName, "Nikolay");
	strcpy(student.lastName, "Nikolaev");
	strcpy(student.middleName, "Nikolaevich");
	strcpy(student.group, "1.KIT102.8b");
	list = Add(list, student);
	ShowList(list);
